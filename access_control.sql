...
-- SNOWFLAKE recommends assigning custom roles to the sysadmin role to give the system admin access
-- to all objects created by the custom roles due to privilege inheritance.
